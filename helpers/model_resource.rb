class ResourceModel < BaseModel
  ...
  def transform( data, ret )
    ...
    ret[:is_educational_resource] = ret[:is_educational_resource] || false
    ret[:is_multimedia_resource] = ret[:is_educational_resource] || false
    ret[:is_teacher_resource] = ret[:is_educational_resource] || false
